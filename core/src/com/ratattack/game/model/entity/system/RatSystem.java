...
public class RatSystem extends IteratingSystem {

    private static final Family ratComponentFamily = Family.all(VelocityComponent.class, PositionComponent.class,
